...
export const PRODUCT_IMAGES = {
  ...
  "Pure Desi Ghee": loadImg("ghee.png"),
...
const FALLBACKS = {
  mango:
    "https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?w=400&q=75",
  dairy:
    "https://images.unsplash.com/photo-1587486913049-53fc88980cfc?w=400&q=75",
  fruit:
    "https://images.unsplash.com/photo-1563746924237-f4471932d9e7?w=400&q=75",
        ...
        <div className="product-card" style={{ width: "100%" }}>
          ...
          <div className="product-card-img">
            <img
              ...
              loading="lazy"
              onError={(e) => {
                e.target.src = FALLBACKS[product.category] || FALLBACKS.mango;
              }}
            />
            {product.badge && (
