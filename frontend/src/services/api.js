...
export const STATIC_PRODUCTS = [
  { _id: '1', name: 'Dasheri Mango', category: 'mango', emoji: '🥭', origin: 'Uttar Pradesh',/*  badge: 'Sweet & Fibrous', */ description: 'The king of mangoes from UP — intensely sweet, silky smooth, and absolutely fibrous-free. Hand-picked at perfect ripeness.', price: 180, unit: 'kg', featured: false, tags: ['bestseller', 'sweet'], inStock: true},
  ...
  { _id: '4', name: 'Shafeda', category: 'mango', emoji: '🥭', origin: 'Maharashtra',/* badge: 'Mild & Fragrant' ,*/ description: 'A Maharashtrian gem — mild sweetness, heavenly fragrance, and silky texture. Perfect for those who prefer subtlety.', price: 180, unit: 'kg', tags: ['fragrant', 'mild'], inStock: false },
  { _id: '5', name: 'Tota Pari', category: 'mango', emoji: '🥭', origin: 'Andhra Pradesh', /*badge: 'Unique Beak Shape', */ description: 'Named for its distinctive parrot-beak shape. Fibre-free, sweet pulp with a beautiful golden hue inside.', price: 180, unit: 'kg', tags: ['unique', 'fibrefree'], inStock: false },
  { _id: '6', name: 'Amrapali', category: 'mango', emoji: '🥭', origin: 'All India',/* badge: 'Regular Bearer', */ description: 'A hybrid mango that fruits regularly through the season. Deep orange pulp, small seed, intensely sweet.', price: 180, unit: 'kg', featured: false, tags: ['hybrid', 'sweet'], inStock: false },
  { _id: '7', name: 'Mallika', category: 'mango', emoji: '🥭', origin: 'Hybrid Variety',/* badge: 'Neelam × Dasheri', */ description: "The best of two worlds — Neelam's aroma meets Dasheri's sweetness. Smooth, rich, and absolutely delicious.", price: 180, unit: 'kg', tags: ['hybrid', 'aromatic'], inStock: false },
