...
export const STATIC_PRODUCTS = [
  ...
  { _id: '3', name: 'Langda', category: 'mango', emoji: '🥭', origin: 'Varanasi', badge: 'Turpentine Free', description: 'The iconic green-skinned mango from Varanasi. Sweet, slightly tangy, and completely turpentine-free. A must-try.', price: 200, unit: 'kg', tags: ['tangy', 'classic'], inStock: true },
  { _id: '4', name: 'Shafeda', category: 'mango', emoji: '🥭', origin: 'Maharashtra', badge: 'Mild & Fragrant', description: 'A Maharashtrian gem — mild sweetness, heavenly fragrance, and silky texture. Perfect for those who prefer subtlety.', price: 220, unit: 'kg', tags: ['fragrant', 'mild'], inStock: true },
  { _id: '5', name: 'Tota Pari', category: 'mango', emoji: '🥭', origin: 'Andhra Pradesh', badge: 'Unique Beak Shape', description: 'Named for its distinctive parrot-beak shape. Fibre-free, sweet pulp with a beautiful golden hue inside.', price: 150, unit: 'kg', tags: ['unique', 'fibrefree'], inStock: true },
  { _id: '6', name: 'Amrapali', category: 'mango', emoji: '🥭', origin: 'All India', badge: 'Regular Bearer', description: 'A hybrid mango that fruits regularly through the season. Deep orange pulp, small seed, intensely sweet.', price: 170, unit: 'kg', featured: true, tags: ['hybrid', 'sweet'], inStock: true },
  { _id: '7', name: 'Mallika', category: 'mango', emoji: '🥭', origin: 'Hybrid Variety', badge: 'Neelam × Dasheri', description: "The best of two worlds — Neelam's aroma meets Dasheri's sweetness. Smooth, rich, and absolutely delicious.", price: 190, unit: 'kg', tags: ['hybrid', 'aromatic'], inStock: true },
  { _id: '8', name: 'Pure Desi Ghee', category: 'dairy', emoji: '🧈', badge: 'A2 Quality', description: "Hand-churned from fresh cow's milk using traditional bilona method. Rich aroma, golden colour, A2 quality.", price: 800, unit: '500ml', featured: true, tags: ['a2', 'bilona', 'traditional'], inStock: true },
