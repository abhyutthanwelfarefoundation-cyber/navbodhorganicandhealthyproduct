...
export const STATIC_PRODUCTS = [
  ...
  { _id: '8', name: 'Pure Desi Ghee', category: 'dairy', emoji: '🧈', origin: 'Raipur, CG',     description: "Hand-churned from fresh cow's milk using traditional bilona method. Rich aroma, golden colour, A2 quality.",                price: 1400, unit: '500ml', featured: true,  tags: ['a2', 'bilona', 'traditional'], inStock: true, badge: 'A2 Quality' },
