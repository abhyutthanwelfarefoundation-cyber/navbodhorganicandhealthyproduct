...
const GheeImg    = loadImg('desi ghee.png')       || 'https://images.unsplash.com/photo-1631209121750-a9f656d28f24?w=700&q=80';
const VARIETIES  = [
...
const Home = () => {
  /* ── Use STATIC_PRODUCTS instantly — no API delay ── */
    ...
    <div style={{ paddingTop: 'var(--nav-h)' }}>
      ...
      <section style={{ position: 'relative', minHeight: 'calc(100vh - var(--nav-h))', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 1,
          background: 'linear-gradient(110deg, rgba(26,44,28,0.93) 0%, rgba(42,75,46,0.80) 45%, rgba(26,44,28,0.50) 100%)' }} />
        {/* Grain */}
        <div style={{ position: 'absolute', inset: 0, zIndex: 2, opacity: 0.45, pointerEvents: 'none',
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="visible"
            ...
            <motion.div variants={fadeUp}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 9,
                background: 'rgba(232,213,176,0.14)', backdropFilter: 'blur(10px)',
                ...
                <span style={{ color: 'var(--beige)', fontSize: 11, fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase' }}>
                  100% Organic · Raipur, CG
                </span>
              </div>
            </motion.div>
            ...
            <motion.h1 variants={fadeUp}
              style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(44px,7.5vw,98px)', color: 'white', lineHeight: 1.02, fontWeight: 600, marginBottom: 22 }}>
              Nature's Finest,<br />
              <motion.em
                style={{ color: 'transparent', fontStyle: 'italic', display: 'block',
                  backgroundImage: 'linear-gradient(90deg, var(--beige) 0%, #f5d98a 50%, var(--beige) 100%)',
            ...
            <motion.p variants={fadeUp}
              style={{ fontSize: 'clamp(15px,1.8vw,18px)', color: 'rgba(255,255,255,0.84)', lineHeight: 1.82, maxWidth: 500, marginBottom: 40 }}>
            ...
            <motion.div variants={fadeUp} style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
              <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                <Link to="/mangoes" className="btn btn-beige btn-lg"
              ...
              {[
                ...
                <motion.div key={i}
                  ...
                  style={{ background: 'rgba(255,255,255,0.10)', backdropFilter: 'blur(14px)',
                    ...
                    padding: '14px 22px', minWidth: 110 }}>
                ...
                <Link to="/mangoes" style={{ textDecoration: 'none' }}>
                  <div className="variety-card">
                    <div className="variety-card-img">
                      <img src={m.img || 'https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?w=300&q=75'}
                        alt={m.name}
...
/>
          ...
          <motion.div style={{ textAlign: 'center', marginTop: 38 }}
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <Link to="/mangoes" className="btn btn-forest btn-lg"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 9 }}>
             <MangoIcon width={18} height={18} />View All Varieties
      ...
      <section className="section" style={{ background: 'white' }}>
        <div className="container">
          ...
          <div style={{ textAlign: 'center', marginTop: 28 }} className="hide-tablet">
            <Link to="/products" className="btn btn-outline mobile-full"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 8, maxWidth: 300 }}>
              See All Products <MdArrowForward size={16} />
            </Link>
          </div>
        </div>
          ...
          <div className="grid-3" style={{ textAlign: 'center', gap: 'clamp(16px,3vw,36px)' }}>
            {[
              ...
              <motion.div key={i}
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1 }}
                viewport={{ once: true }}
                transition={{ delay: i * 0.15, duration: 0.6, ease: [0.34, 1.2, 0.64, 1] }}
                ...
                <div style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(42px,6vw,72px)', fontWeight: 700, color: 'var(--beige)', lineHeight: 1 }}>
                  {s.value}
                </div>
      ...
      <section className="section" style={{ background: 'var(--beige-warm)' }}>
        <div className="container">
          <motion.div style={{ textAlign: 'center', marginBottom: 'clamp(28px,4vw,56px)' }}
            initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.span variants={fadeUp} className="eyebrow" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, marginBottom: 12 }}>
          ...
          <div className="grid-4">
            {PILLARS.map(({ Icon, title, desc }, i) => (
              <motion.div key={i}
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1 }}
                viewport={{ once: true, margin: '-30px' }}
                transition={{ delay: i * 0.1, duration: 0.55, ease: [0.34, 1.2, 0.64, 1] }}
                whileHover={{ y: -8, boxShadow: '0 24px 60px rgba(58,92,63,0.20)' }}
                ...
                <motion.div
                  style={{ width: 54, height: 54, borderRadius: 15, background: 'var(--forest-mist)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 18 }}
          ...
          <div className="grid-2" style={{ alignItems: 'center', gap: 'clamp(32px,6vw,84px)' }}>
            <motion.div
              ...
              <div style={{ borderRadius: 28, overflow: 'hidden', boxShadow: 'var(--shadow-xl)', position: 'relative' }}>
                ...
                {/* <motion.div
                  ...
                  style={{ position: 'absolute', bottom: 22, left: 22, right: 22, background: 'rgba(250,246,238,0.96)', backdropFilter: 'blur(14px)', borderRadius: 16, padding: '16px 20px', border: '1px solid var(--border)' }}>
                  <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--soil-light)', marginBottom: 5 }}>Bilona Method</div>
                  <div style={{ fontFamily: 'var(--font-display)', fontSize: 20, fontWeight: 600, color: 'var(--ink)' }}>A2 Desi Cow Ghee</div>
                  <div style={{ fontSize: 12, color: 'var(--ink-soft)', marginTop: 4 }}>Hand-churned · Traditional · Pure A2</div>
                </motion.div> */}
              </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-60px' }} variants={staggerContainer}>
              ...
              <motion.p variants={fadeUp} style={{ fontSize: 'clamp(13px,1.4vw,16px)', color: 'var(--ink-mid)', lineHeight: 1.85, marginTop: 18 }}>
                Our Pure Desi Ghee is hand-churned from fresh A2 cow's milk using the traditional <em>Bilona</em> method — slow-churned, separated, and simmered to golden perfection. No shortcuts, no additives.
              </motion.p>
              ...
              <motion.div variants={fadeUp} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Link to="/products/8" className="btn btn-forest btn-lg"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 9 }}>
                  <GiMilkCarton size={17} /> Shop Desi Ghee
                  <MdArrowForward size={16} />
                </Link>
              </motion.div>
            </motion.div>
          ...
          <div className="grid-3">
            {TESTIMONIALS.map((t, i) => (
              <motion.div key={i}
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1 }}
                viewport={{ once: true, margin: '-30px' }}
                transition={{ delay: i * 0.12, duration: 0.55, ease: [0.34, 1.2, 0.64, 1] }}
                whileHover={{ y: -6, boxShadow: '0 24px 56px rgba(58,92,63,0.16)' }}
                ...
                <Stars n={t.stars} />
                <p style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(16px,1.6vw,19px)', lineHeight: 1.75, color: 'var(--ink)', fontStyle: 'italic', flex: 1, margin: '16px 0' }}>
                  "{t.text}"
                </p>
      ...
      <section style={{ background: 'var(--forest)', padding: 'clamp(56px,8vw,96px) 0', position: 'relative', overflow: 'hidden' }}>
        <motion.div style={{ position: 'absolute', top: -60, right: -60, width: 320, height: 320, borderRadius: '50%', background: 'rgba(255,255,255,0.05)', pointerEvents: 'none' }}
          animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }} />
        <motion.div style={{ position: 'absolute', bottom: -40, left: '30%', width: 180, height: 180, borderRadius: '50%', background: 'rgba(232,213,176,0.06)', pointerEvents: 'none' }}
        ...
        <div className="container" style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.h2 variants={fadeUp} style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(30px,5vw,58px)', color: 'white', marginBottom: 14 }}>
              Ready to Go Organic?
            </motion.h2>
        ...
        <div className="container">
          <div className="grid-2" style={{ gap: 'clamp(32px,6vw,72px)', alignItems: 'start' }}>
            ...
            <motion.div
              ...
              <form onSubmit={handleForm} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
