...
const VARIETIES = [
  {
    ...
    badge: "Sweet & Fibrous",
    img: loadImg("Dasherimango.png"),
  },
  {
    name: "Banganapalli",
    origin: "Andhra Pradesh",
    badge: "Large & Juicy",
    img: loadImg("Banganapallimango.png"),
  },
  {
    name: "Langda",
    origin: "Varanasi",
    badge: "Turpentine Free",
    img: loadImg("Langdamango.png"),
  },
  {
    name: "Shafeda",
    origin: "Maharashtra",
    badge: "Mild & Fragrant",
    img: loadImg("Shafedamangoes.png"),
  },
  {
    name: "Tota Pari",
    origin: "Andhra Pradesh",
    badge: "Unique Beak Shape",
  ...
  },
  {
    ...
    badge: "Neelam × Dasheri",
    img: loadImg("Mallikamangoes.png"),
  },
];
...
const TESTIMONIALS = [
  {
    ...
    loc: "Samta Colony",
    stars: 5,
    text: "Best mangoes I've ever tasted in Raipur! The Dasheri variety is absolutely divine. Fresh, sweet, zero chemicals — you can taste the difference.",
  },
  {
    name: "Rahul Verma",
    loc: "Raipur",
    stars: 5,
    text: "Their desi ghee is pure and aromatic — exactly the way my dadi used to make it. Regular customer for ghee and milk. Highly recommended!",
  },
  {
    name: "Anita Tiwari",
    loc: "Civil Lines",
    stars: 4,
    text: "Love the variety of mangoes here — from Langda to Amrapali, everything is fresh and naturally ripened. Great organic store in Raipur.",
  },
];
...
const PILLARS = [
  {
    Icon: IoLeafOutline,
    title: "100% Organic",
    desc: "No pesticides, no chemicals. Every product grown and sourced naturally to protect your health and the planet.",
  },
  {
    Icon: TbTractor,
    title: "Direct from Farm",
    desc: "We cut out middlemen and source straight from trusted farmers — fresher produce, fair farmer prices.",
  },
  {
    Icon: MdDeliveryDining,
    title: "Fresh Delivery",
    desc: "Farm-fresh products at peak freshness. Quick delivery across Raipur and surrounding areas daily.",
  },
  {
    Icon: BsShieldCheck,
    title: "Trusted Quality",
    desc: "3.8★ Google rating with hundreds of happy families. Quality you can taste in every bite.",
  },
];
  ...
  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
    <label
      style={{
        ...
        color: error ? "#dc2626" : "var(--ink-mid)",
      }}
    >
      {label}
    </label>
...
const Home = () => {
  ...
  const nonMangoProds = products
    .filter((p) => p.category !== "mango")
    .slice(0, 6);
  ...
  useEffect(() => {
    if (statsInView) setStatsGo(true);
  }, [statsInView]);
  ...
  useEffect(() => {
    ...
    Object.keys(touched).forEach((k) => {
      if (touched[k] && e[k]) visible[k] = e[k];
    });
    setErrors(visible);
  }, [form, touched]);
    ...
    <div style={{ paddingTop: "var(--nav-h)" }}>
      ...
      >
        ...
        <div
          style={{
            ...
            zIndex: 1,
            background:
              "linear-gradient(110deg, rgba(26,44,28,0.93) 0%, rgba(42,75,46,0.80) 45%, rgba(26,44,28,0.50) 100%)",
          }}
        />
        <div
          style={{
            ...
            pointerEvents: "none",
            backgroundImage:
              "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='g'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.75' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23g)' opacity='0.05'/%3E%3C/svg%3E\")",
          }}
        />
        <FloatingLeaves />
          ...
          >
            ...
            <motion.h1
              ...
              style={{
                ...
                fontSize: "clamp(44px,7.5vw,98px)",
                color: "white",
                lineHeight: 1.02,
                fontWeight: 600,
                marginBottom: 22,
            ...
            >
              ...
              <motion.em
                style={{
                  ...
                  display: "block",
                  backgroundImage:
                    "linear-gradient(90deg, var(--beige) 0%, #f5d98a 50%, var(--beige) 100%)",
            ...
            >
              Premium organic mangoes, pure ghee, fresh milk, jackfruit and more
              — straight from nature's heart to your family's table.
            </motion.p>
      ...
      <section className="section" style={{ background: "var(--cream)" }}>
        <div className="container">
          ...
          >
            ...
            >
              Hand-picked at peak ripeness from the finest orchards across India
              — 7 premium varieties.
            </motion.p>
          </motion.div>
                  ...
                  <div className="variety-card">
                    <div className="variety-card-img">
                      <img
                        src={
                          m.img ||
                          "https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?w=300&q=75"
                        }
                        alt={m.name}
                        onError={(e) => {
                          e.target.src =
      ...
      <section className="section" style={{ background: "white" }}>
        <div className="container">
          ...
          >
            <div>
              ...
              <motion.p variants={fadeUp} className="section-sub">
                Beyond mangoes — pure, farm-fresh products for every kitchen
              </motion.p>
            </div>
          ...
          <div className="grid-auto">
            {(featuredProds.length > 0 ? featuredProds : nonMangoProds)
              .slice(0, 6)
              .map((p, i) => (
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div
            className="grid-3"
            style={{ textAlign: "center", gap: "clamp(16px,3vw,36px)" }}
          >
            {[
              {
                value: `${(ratingV / 10).toFixed(1)}★`,
                label: "Google Rating",
              ...
              },
              {
                ...
                sub: "Premium organic",
                Icon: () => <MangoIcon width={36} height={36} />,
              },
              {
                value: `${familiesV}+`,
                label: "Happy Families",
                sub: "Served in Raipur",
                Icon: BsShieldCheck,
              },
            ].map((s, i) => (
              <motion.div
        ...
        <div className="container">
          ...
          >
            ...
            <motion.p
              ...
              style={{ margin: "12px auto 0", textAlign: "center" }}
            >
              We're not just a store — we're your trusted organic partner,
              committed to quality and your family's health.
            </motion.p>
          </motion.div>
          <div className="grid-4">
            {PILLARS.map(({ Icon, title, desc }, i) => (
              <motion.div
                ...
                whileHover={{
                  y: -8,
                  boxShadow: "0 24px 60px rgba(58,92,63,0.20)",
                }}
                style={{
                  background: "white",
                  borderRadius: 18,
      ...
      >
        <div className="container">
          <div
            className="grid-2"
            style={{ alignItems: "center", gap: "clamp(32px,6vw,84px)" }}
          >
            <motion.div
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              >
                <GiFarmer size={14} color="var(--forest-mid)" /> Pure &amp;
                Authentic
              </motion.span>
              <motion.h2
                variants={fadeUp}
              ...
              >
                Our Pure Desi Ghee is hand-churned from fresh A2 cow's milk
                using the traditional <em>Bilona</em> method — slow-churned,
                separated, and simmered to golden perfection.
              </motion.p>
              <motion.div
                variants={fadeUp}
                style={{
          ...
          <div className="grid-3">
            {TESTIMONIALS.map((t, i) => (
              <motion.div
                ...
                whileHover={{
                  y: -6,
                  boxShadow: "0 24px 56px rgba(58,92,63,0.16)",
                }}
                style={{
                  background: "white",
                  borderRadius: 20,
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <IoLocationSharp size={11} color="var(--soil-light)" />{" "}
                      {t.loc}
                    </div>
                  </div>
                </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Join hundreds of happy families in Raipur enjoying fresh,
              chemical-free produce delivered to their door.
            </motion.p>
            <motion.div
              variants={fadeUp}
              style={{
      ...
      <section className="section" style={{ background: "var(--cream-warm)" }}>
        <div className="container">
          <div
            className="grid-2"
            style={{ gap: "clamp(32px,6vw,72px)", alignItems: "start" }}
          >
            {/* Contact info */}
            <motion.div
              initial="hidden"
            ...
            >
              ...
              {[
                {
                  ...
                  label: "Address",
                  val: "Okinawa Showroom Buliding , 1st Floor , Bangrang Nagar Main Rd,\nRaipur, Chhattisgarh 492001",
                  href: null,
                },
                {
                  Icon: MdPhone,
              ...
              <motion.div variants={fadeUp} whileHover={{ scale: 1.03 }}>
                <a
                  href="https://maps.app.goo.gl/Wt4u1rJh9xZoabLaA "
                  target="_blank"
            ...
            >
              ...
              >
                ...
                <Field label="Product Interested In" error={errors.product}>
                  <input
                    type="text"
                    placeholder="e.g. Dasheri Mango, Desi Ghee…"
                    value={form.product}
                    onChange={(e) =>
