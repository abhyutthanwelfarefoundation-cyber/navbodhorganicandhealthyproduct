...
const ProductDetail = () => {
  ...
  if (!product)
    return (
      <div
        style={{
          paddingTop: "calc(var(--nav-h) + 100px)",
          textAlign: "center",
          minHeight: "60vh",
          display: "flex",
          alignItems: "center",
  ...
  return (
    <div style={{ paddingTop: "var(--nav-h)" }}>
      ...
      >
        ...
        >
          <Link to="/" style={{ color: "var(--forest-mid)" }}>
            Home
          </Link>
          <span>/</span>
          <Link to="/products" style={{ color: "var(--forest-mid)" }}>
            Products
          </Link>
          <span>/</span>
          ...
          >
            ...
            <div>
              ...
              {product.price ? (
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        onMouseEnter={(e) =>
                          (e.target.style.background = "var(--forest-mist)")
                        }
                        onMouseLeave={(e) =>
                ...
                <a href="tel:7471145013" className="btn btn-forest btn-lg">
                  📞 Call to Enquire
                </a>
              )}
              ...
              >
                🚚 <strong>Free delivery</strong> across Raipur · 📦 Same-day
                dispatch available · 📞{" "}
                <a href="tel:7471145013" style={{ color: "var(--forest)" }}>
                  7471145013
                </a>
              </div>
            </div>
      ...
      {related.length > 0 && (
        <section
          ...
          style={{ background: "var(--forest-mist)" }}
        >
          <div className="container">
            <div className="eyebrow" style={{ marginBottom: 10 }}>
              You Might Also Like
                ...
                >
                  <div className="product-card">
                    ...
                    <div className="product-card-body">
                      <h4 className="product-name" style={{ fontSize: 16 }}>
                        {p.emoji} {p.name}
                      </h4>
                      {p.price && (
                        <div
